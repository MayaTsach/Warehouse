...
class Volunteer {
    public:
        ...
        virtual string getVolunteerType() const = 0; //gets back the volunteer type- collector or driver
        ...
        virtual ~Volunteer() = default; // Add a virtual destructor
...
class CollectorVolunteer: public Volunteer {
    ...
    public:
        ...
        string getVolunteerType() const override; //gets back the volunteer type- collector or driver
        string toString() const override;

        ~CollectorVolunteer() override = default; // Add a virtual destructor
...
class LimitedCollectorVolunteer: public CollectorVolunteer {
    ...
    public:
        ...
        ~LimitedCollectorVolunteer() override = default; // Add a virtual destructor
...
class DriverVolunteer: public Volunteer {
    ...
    public:
        ...
        ~DriverVolunteer() override = default; // Add a virtual destructor
...
class LimitedDriverVolunteer: public DriverVolunteer {
    ...
    public:
        ...
        ~LimitedDriverVolunteer() override = default; // Add a virtual destructor
