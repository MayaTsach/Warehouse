...
class Customer {
    public:
        ...
        virtual ~Customer() = default; // Add a virtual destructor
...
class SoldierCustomer: public Customer {
    public:
        ...
        ~SoldierCustomer() override = default; // Add a virtual destructor
...
class CivilianCustomer: public Customer {
    public:
        ...
        ~CivilianCustomer() override = default; // Add a virtual destructor
